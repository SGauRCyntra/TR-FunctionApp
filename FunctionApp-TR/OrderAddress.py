...
class orderAddress():
    ...
    # Create client
        try:
            ...
            headers = ["SupplierNumber", "FacilityCode", "FacilityName", "Status"]
            headers_to_change = ["Vendor_No", "Code" ,"Name" ,"Status" ,"Address" ,"Address_2" ,"City" ,"County" ,"Post_Code", "Country_Region_Code" ,"Phone_No","Contact" ,"Fax_No" ,"E_Mail"]
            orderAdd = []
